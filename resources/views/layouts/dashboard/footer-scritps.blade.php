...
<!-- custom js -->
<script src="{{ URL::asset('dashboard/custom/order.js') }}"></script>
<script src="{{ URL::asset('dashboard/custom/printThis.js') }}"></script>
<script src="{{ URL::asset('dashboard/custom/jquery.number.min.js') }}"></script>
